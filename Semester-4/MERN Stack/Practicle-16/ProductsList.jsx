            ...
            <div className="row">
                {
                    products.map((value)=>
                        <div className="card" style={{width: "23%",margin: "10px"}}>
                            <img src={value.LaptopImage} />
                            <div className="card-body">
                                <h5 className="card-title">{ value.LaptopName }</h5>
                                <h6 className="card-subtitle mb-2 text-muted">{ value.LaptopCompany }</h6>
                                <p className="card-text">{ value.LaptopPrice }</p>
                            </div>
                        </div>
                    )
                }
